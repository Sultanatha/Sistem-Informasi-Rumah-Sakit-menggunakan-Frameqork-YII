...
class DrugController extends Controller
{
     ...
     */
    public function actionView($drug_id)
    {
        return $this->render('view', [
            'model' => $this->findModel($drug_id),
        ]);
    }
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'drug_id' => $model->drug_id]);
            }
        } else {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($drug_id)
    {
        $model = $this->findModel($drug_id);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($drug_id)
    {
        $this->findModel($drug_id)->delete();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($drug_id)
    {
        if (($model = Drug::findOne(['drug_id' => $drug_id])) !== null) {
            return $model;
        }
